...
live2d_settings['modelTexturesId']      = 118;           // 默认材质 ID，可在 F12 控制台找到
...
//看板娘样式设置
live2d_settings['waifuSize']            = '300x340';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '310x70';     // 提示框大小，例如 '250x70', '570x150'
...
live2d_settings['waifuEdgeSide']        = 'left:5';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
