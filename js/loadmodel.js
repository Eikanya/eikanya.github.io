...
try {
	...
	$.ajax({url: "../live2dv3/pixi/pixi.min.js", dataType:"script", cache: true, success: function() {
        $.ajax({url: "../live2dv3/framework/live2dcubismpixi.js", dataType:"script", cache: true, success: function() {
            $.ajax({url: "../live2dv3/framework/live2dcubismframework.js", dataType:"script", cache: true, success: function() {
